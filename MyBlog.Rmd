...
knitr::include_graphics("https://i.imgur.com/zg5Av51h.jpg") 
```
</div>
<div style= "float:left;position: relative; right: 30px; top: -7px;">
```{r echo=FALSE, out.width="350px", fig.align='left'}
knitr::include_graphics("https://i.imgur.com/u7fV8S5h.jpg") 
```
</div>
<div style= "float:left;position: relative; right: 30px; top: -7px;">
```{r echo=FALSE, out.width="350px", fig.align='left'}
knitr::include_graphics("https://i.imgur.com/ICmEvOSh.jpg") 
```
</div>
<div style= "float:left;position: relative; right: 30px; top: -7px;">
```{r echo=FALSE, out.width="350px", fig.align='left'}
knitr::include_graphics("https://i.imgur.com/tZyvTcJh.jpg") 
```
</div>

<div style= "float:left;position: relative; right: 30px; top: -7px;">
```{r echo=FALSE, out.width="350px", fig.align='left'}
knitr::include_graphics("https://i.imgur.com/02Ch8zjh.jpg") 
```
</div>
<div style= "float:left;position: relative; right: 30px; top: -7px;">
```{r echo=FALSE, out.width="350px", fig.align='left'}
knitr::include_graphics("https://i.imgur.com/SNMWoJBh.jpg") 
```
</div>
